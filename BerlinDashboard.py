...
def run():
    ...
    img = Image.open('logo 2.jpeg')
    # img = img.resize((1000,1000))
    st.image(img)
    st.title('Covid-19 Report Dashboard for Berlin City')

    link = '[©Developed by Danial Choo](https://www.linkedin.com/in/danialchoo/)'
...
st.write('''
    Dashboard created by [Danial Choo](https://www.linkedin.com/in/danialchoo/), with [Streamlit](https://www.streamlit.io).
    See the code on [GitHub](https://github.com/danialchoo97/covid-dashboard-berlin).
